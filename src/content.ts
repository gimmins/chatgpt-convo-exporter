...
function scrapeChat(): ChatMessage[] {
  const turnNodes: NodeListOf<HTMLElement> = document.querySelectorAll(
...
function exportChatAsText(chat: ChatMessage[], filename: string): void {
  const text = chat
